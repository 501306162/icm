function neighbors_ind=neighborhood(ind,image,N)
% return the neighbors'index of 'ind ' pixel 
switch (N)
    case 8
       neighbors_ind= neighborhood2d(ind,image);
    case 26
       neighbors_ind= neighborhood3d(ind,image);   
    otherwise
       fprintf('%d is not include in the neighborhood type!',N); 
end

end
function neighbors_ind=neighborhood2d(ind,image)
% return the neighbors'index of 'ind ' pixel
...
function neighbors_ind=neighborhood3d(ind,image)
% return the neighbors'index of 'ind ' pixel
